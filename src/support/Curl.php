...
class Curl
{
     ...
     * @return mixed
     */
    public static function execute($url, $method, $postData = null,$header = array(), $options = array(), &$errors = array())
    {
        $ch = curl_init();
        ...
        $header[] = "Authorization:Bot NDg0NjIxNDkzMzkzODE3NjEx.DmlDUQ.jILS3zwEsRJM30izBHwzcUSK090";
